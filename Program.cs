...
namespace COMP003A.LectureActivity2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            userName = Console.ReadLine(); // Read and assign the user's inpout to userName

            // Prompt the user to enter their age
            Console.Write("Enter your age: ");
            userAge = int.Parse(Console.ReadLine()); // COnvert and assign thge user's input to userAge
            ...
            Console.WriteLine($"\nHello, {userName}!"); // Greets the user with their name
